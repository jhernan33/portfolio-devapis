...
def test_misma_ip_mismo_hash():
    ...
    assert privacy.anonymize_ip("203.0.113.45", SAL)[1] == privacy.anonymize_ip("203.0.113.45", SAL)[1]


def test_ips_distintas_hashes_distintos():
    assert privacy.anonymize_ip("203.0.113.45", SAL)[1] != privacy.anonymize_ip("203.0.113.46", SAL)[1]
